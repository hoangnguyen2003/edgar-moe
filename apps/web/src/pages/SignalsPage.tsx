            ...
            <table className="blotter__table">
              <thead>
                <tr>
                  ...
                  <th scope="col"><span className="th-with-tip">What happened <InfoTip term="target" /></span></th>
                  <th scope="col"><span className="sr-only">Details</span></th>
                </tr>
              </thead>
              <tbody>
                {group.map((signal) => <SignalRow key={signal.event_id} signal={signal} scale={scale} />)}
              </tbody>
            </table>
          </section>
        );
...
function SignalRow({ signal, scale }: { signal: EventRecord; scale: number }) {
  ...
  return (
    <tr>
      ...
      <td data-label="What happened"><CallOutcome event={signal} scale={scale} /></td>
