...
class RuntimeSettings(BaseSettings):
    ...
    edgar_moe_copilot_max_duration_seconds: float = Field(default=300.0, ge=1, le=900)
    edgar_moe_copilot_max_context_bytes: int = Field(
        default=512 * 1024, ge=16 * 1024, le=2 * 1024 * 1024
    )
