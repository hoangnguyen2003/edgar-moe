...
| Research copilot | Operator-run LLM explanation and evidence navigation | Bounded read-only tools; citations and frozen identity are retained; no forecast, registry, artifact, or GitHub writes |
