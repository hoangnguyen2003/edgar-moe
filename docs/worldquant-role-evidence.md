...
| [Python Developer](https://www.worldquant.com/career-listing/?id=4673851006): production Python, ML/backtesting platforms, algorithms and concurrency | [Point-in-time builder](../src/edgar_moe/features/dataset.py), [walk-forward training](../src/edgar_moe/modeling/walk_forward.py), [backtest](../src/edgar_moe/backtest/engine.py) | No measured evidence that a proposed pipeline concurrency change improves throughput safely | Proposed bounded-ingestion benchmark and deterministic failure-injection test; the project cannot establish seven years' experience |
...
| [Senior Backend Engineer](https://www.worldquant.com/career-listing/?id=4653484006): database design, query optimization, API/network boundaries | [Migrations](../alembic/versions), [reader-role audit](../src/edgar_moe/forward/reader_role.py), [API tests](../tests/integration/test_forward_api.py) | No production-scale query-plan and p95 evidence for the read path | Proposed Postgres `EXPLAIN`/latency report with a regression threshold; senior tenure/mentoring are not provable here |
| [Senior Software Engineer](https://www.worldquant.com/career-listing/?id=4672066006): ETL ownership, architecture trade-offs and incident response | [Refresh pipeline](../src/edgar_moe/data/refresh.py), [solution architecture](solution-architecture.md), [restore rehearsal](restore-rehearsal.md) | Provider-side failure recovery and scale limits remain partly unverified | Proposed retained provider restore/audit evidence and measured ETL fault-injection report; eight years' experience is not a project claim |
